...
FlowRouter.route('/building/assessment/:buildingId/:assessmentId/:order', {
  name: 'buildingAssessment',
  triggersEnter: [checkLoggedIn],
  subscriptions: function (params, queryParams) {
    this.register('building', Meteor.subscribe('singleBuilding', params.buildingId));
    this.register('assessments', Meteor.subscribe('singleAssessment', params.assessmentId));
    this.register('assessmentElementGroups', Meteor.subscribe('singleAssessmentElementGroups', params.assessmentId));
    this.register('assessmentElements', Meteor.subscribe('singleAssessmentElements', params.assessmentId));
    this.register('assessmentRules', Meteor.subscribe('singleAssessmentRules', params.assessmentId));
  },
  action: function (params, queryParams) {
    FlowLayout.render('main-layout', { top: 'header', main: 'buildingAssessment' });
  }
});
...
FlowRouter.route('/building/scorecard/:buildingId', {
  ...
  action: function (params, queryParams) {
    FlowLayout.render('main-layout', { top: 'header', main: 'buildingScorecard' });
  }
});
